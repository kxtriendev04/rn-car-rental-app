        ...
        return (
          <>
            <TouchableOpacity
              ...
              onPress={onReject}
            >
              <Text style={{ color: getStatusTextColor("rejected") }}>Từ chối</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.button, {
        ...
        return (
          <>
            <TouchableOpacity
              ...
              onPress={onReject}
            >
              <Text style={{ color: getStatusTextColor("rejected") }}>Huỷ đơn</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.button, {
              ...
              onPress={onDelivered}
            >
              <Text style={{ color: getStatusTextColor("completed") }}>Giao xe</Text>
            </TouchableOpacity>
          </>
        );
      case "approved":
        return (
          <TouchableOpacity
            ...
            onPress={onReturned}
          >
            <Text style={{ color: getStatusTextColor("completed") }}>Đã nhận lại xe</Text>
          </TouchableOpacity>
        );
      default:
        return null;
